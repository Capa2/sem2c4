    ...
    <jsp:body>
        ...
        <c:forEach var="carport" items="${applicationScope.models}">
            ...
            <div class="col-3 m-2  p-2 rounded border border-2 border-secondary"><h4 class="h4">
                ...
                <a href="${pageContext.request.contextPath}/fc/modelpage1?model=${carport.id}">
        ...
        <div class="row">
            <div class="row col-9 m-n2 p-n2">
                <div class="col-3 m-2  p-2 rounded border border-2 border-secondary"><h4 class="h4">
                    ...
                    <p>Tag: Fladt</p>
                    <p><strong>399,- kr.</strong></p>
                    <a href="${pageContext.request.contextPath}/fc/modelpage1">
                        <button class="btn btn-success float-right" name="CAR01H" value="CAR01H">Læs mere
                        </button>
                    </a>
                </div>
                <div class="col-3 m-2  p-2 rounded border border-2 border-secondary"><h4 class="h4">
            ...
            <div class="col-3">
                <div class="mb-4">
                    <form>
                        ...
                        <button class="mt-4 btn btn-secondary w-100" name="Filtrer" value="filter">Filtrer</button>
                    </form>
                </div>
                <hr>
